    ...
    >
      <template v-slot:top>
        <v-toolbar flat class="secondary">
          <v-toolbar-title class="white--text">Meine Feeds</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-dialog v-model="dialog" max-width="500px">
            ...
            <v-card>
              ...
              <v-card-actions>
                ...
                <v-btn color="success darken-1" text @click="save"> Speichern </v-btn>
              </v-card-actions>
            </v-card>
          </v-dialog>
          <v-dialog v-model="dialogDelete" max-width="500px">
            <v-card>
              <v-card-title class="headline"
                >Willst du den Feed wirklich entfernen?</v-card-title
              >
              <v-card-actions>
                <v-spacer></v-spacer>
      ...
      <template v-slot:[`item.categories`]="{ item }">
        <v-chip v-for="category in item.categories" :key="category">{{category}}</v-chip>
      </template>
